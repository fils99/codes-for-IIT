...
for e=1:Nt
    ...
    for q=1: L_q
        ...
        sol_ex_valutata = sol_esatta_bis(nodo_q_globale(1),  nodo_q_globale(2)); % sol esatta o sol esatta bis
        grad_sol_ex_valutato = grad_soluz_esatta_bis( nodo_q_globale(1),  nodo_q_globale(2)); % grad esatto o grad esatto bis
        ...
        differ_grad = differ_grad + omega(q) * (grad_sol_ex_valutato - (inv(B))' * grad_approx)' * (grad_sol_ex_valutato - (inv(B))' * grad_approx) ;
