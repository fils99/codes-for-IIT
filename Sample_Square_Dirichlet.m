...
BC.Boundary.Values = [3 5 7 9]; % 2 4 6 8 per imporre neumann (max 3 lati se non hai termine reazione)
% marker dei Vertici iniziali
BC.InputVertexValues = [1 1 1 1]; % 0 lo metti nei vertici fra due lati di Neumann; primo vertice è quello in basso a sx
...
RefiningOptions.AreaValue  = area_max; % all'inizio 0.02
